...
class cChartSNT
{
	...
	function init(){
		return("<script language=\"JavaScript\" src=\"".STD_LOCATION.'/shared'."/lib/charts.js\"></script>");
	}	
	...
	function htmlPie($serie=null)
	{
	    ...
	    $xml.="var myChart = new FusionCharts(\"".STD_LOCATION.'/shared'."/lib/pie3D.swf\", \"myChartId".time()."\", \"".$this->width."\", \"".$this->height."\", \"0\", \"0\");";	    
	...
	{		
	    ...
	    $xml ="\n<div id=\"chartdiv\" align=\"center\"></div>\n";
	    $xml.="<script type=\"text/javascript\">";
	    $xml.="var myChart = new FusionCharts(\"".STD_LOCATION.'/shared'."/lib/bar3D.swf\", \"myChartId".time()."\", \"".$this->width."\", \"".$this->height."\", \"0\", \"0\");";
        $xml.="myChart.setDataXML(\"";         
	...
	{		
	    ...
	    $xml ="<script language=\"JavaScript\" src=\"".STD_LOCATION.'/shared'."/lib/charts.js\"></script>\n<div id=\"chartdiv\" align=\"center\"></div>\n";
	    $xml.="<script type=\"text/javascript\">";
	    $xml.="var myChart = new FusionCharts(\"".STD_LOCATION.'/shared'."/lib/linebar3D.swf\", \"myChartId".time()."\", \"".$this->width."\", \"".$this->height."\", \"0\", \"0\");";
        $xml.="myChart.setDataXML(\"";         
