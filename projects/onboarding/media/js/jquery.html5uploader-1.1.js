...
(function ($) {
    ...
    // Wait 1:40 seconds before timeout.
    var MAXIMUM_WAITING_TIME = 100000;

    $.fn.html5Uploader = function (options) {
        var settings = {

            // Settings.
            postUrl: "./template/upload",
            cropRatio: 800 / 600,
            maxLength: 2880,
        ...
        function scaleAndCropImage(img) {
            ...
            var cropRatio = img.width/img.height;
        ...
        function realUploadImage(blob) {
            ...
            xmlHttpRequest.upload.onprogress = function (evt) {
                if (evt.lengthComputable && settings.onUploadProgress) {
                    ...
                    //$('.fa.fa-spin').show().parent().text().percentComplete+'%');
        ...
        $( "#MenuOptions" ).empty();
        $('#MenuOptions').css("background-color","rgba(0,0,0,0.7)");
       
        Share.incrementScore(true);
       
        //$('#MenuOptions').append('<div class="icon_retake"><input type="button" onclick="Retake()"  id="botonFotoRetake" class="b_photo_retake" value="Retake"><input type="button"  id="botonFotosend" class="b_photo_send" value="Share"></input> </div>');//onclick="Use()"
        $('#MenuOptions').append('<div class="icon_retake"><input type="button" onclick="Retake()"  id="botonFotoRetake" class="b_photo_retake" value="Retake"><input type="button"  id="botonFotosend" disabled="true" class="b_photo_send waiting-off" value="Share"><i class="fa fa-refresh fa-spin"></input> </div>');
            // Success.
            return true;
        }
