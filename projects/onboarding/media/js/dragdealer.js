...
/*----------------------------------------------------------------------------
------------function added to select pager indicator on current slide---------
-----------------------------------------------------------------------------*/
function activeitem(){
  var slides = $(".handle .slide").length-1;
  activeClass = "centered-btns_here",
  // Pager
  $pager = $(".centered-btns_tabs");
  $slide = $(".slide.current");
  ...
  // Determine where to slide
    ...
    if(idx !== slides){
      $(".centered-btns_tabs").css("display","block");
      // Select pager item
      $tabs = $pager.find('a'),
      $tabs
      .closest("li")
      ...
      $(".centered-btns_tabs").css("display","none");
    }
};
